...
This course can be taken on [Coursera for certification here](https://www.coursera.org/learn/smarter-scientific-software-development-with-github-actions) (but it is not available for free on Coursera). 
